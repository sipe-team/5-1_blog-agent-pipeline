...
- 어느 정도 알아야 글로 쓸 수 있는 걸까?
- 글을 쓴다면 다들 어느 정도 수준으로 쓰는지 궁금하다. (블로그 염탐 예정)
- 블로그 글을 쓰는 과정 자체가 공부에 도움이 된다고 생각하는데 자동화로 하면 도움이 될까?

## 인사이트 / 배운 것

- Claude 세션에 생각보다 많은 데이터가 쌓인다는 걸 알게 됐다.
- Claude가 도와주니까 지표같은 걸 뽑는게 굉장히 편해졌다. (대시보드 만들기, 작은 툴 만들기)
